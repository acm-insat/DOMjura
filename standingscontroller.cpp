...
namespace DJ
{
    namespace Controller
    {
        ...
        void StandingsController::initStandings()
        {
            ...
            std::sort(problems.begin(), problems.end(), problemLessThan);
            ...
            std::sort(this->currentRanking.begin(), this->currentRanking.end(), rankedTeamLessThan);
        ...
        QString StandingsController::toString()
        {
            ...
            for (int i = 0; i < this->currentRanking.size(); i++)
            {
                ...
                if (i > 0)
                {
                    ...
                    if (team->getNumSolved() == prevTeam->getNumSolved() && team->getTotalTime() == prevTeam->getTotalTime())
                    {
